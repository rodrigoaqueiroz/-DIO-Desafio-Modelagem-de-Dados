...
- Criar a estrutura, inserir dados e realizar queries em banco SQL;
- Queriar, ordenar e fazer join para os desafios do módulo _Modelagem de Dados e Projetos Lógicos na Prática com SQL_
...
Disclaimer: Os dados foram mockados usando o Chat-GPT.
---
# Contatos
